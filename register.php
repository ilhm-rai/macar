                    ...
                    <div class="card">
                        <form action="" method="post" id="registerForm">
                            <div class="form-group">
                                ...
                                <input type="text" name="fullname" id="fullname" class="form-custom" value="<?= (isset($_POST['fullname'])) ? $_POST['fullname'] : ''; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <input type="submit" name="submit" value="Daftar" class="btn btn-success w-100">
                        </form>
